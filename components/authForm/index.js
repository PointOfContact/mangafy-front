...
const AuthForm = ({
  ...
  const signInOrSignUp = asPath === '/sign-in' ? 'in' : 'up';
        ...
        <>
          ...
          <div className={styles.social_login}>
            <Link href="/api/v2/auth/google">
              <a>
                <span className={cn(styles.google_btn, styles.btn)}>
                  <SvgGoogle width="26px" height="26px" /> Sign {signInOrSignUp} with Google
                </span>
              </a>
            </Link>
            <Link href="/api/v2/auth/facebook">
              <a>
                <span className={cn(styles.google_btn, styles.btn)}>
                  <SvgWhiteFacebook width="26px" height="26px" /> Sign {signInOrSignUp} with
                  Facebook
                </span>
              </a>
            </Link>
