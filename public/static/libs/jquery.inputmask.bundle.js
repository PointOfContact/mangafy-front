      ...
      function maskScope(actionObj, maskset, opts) {
            ...
            if (baseOnInput === true && getMaskSet().validPositions[pos]) {
              testPos =
                ...
                (getMaskSet().validPositions[pos].generatedInput === true ||
                  (getMaskSet().validPositions[pos].input == opts.skipOptionalPartCharacter &&
                    pos > 0))
              ...
              ndxIntlzr = testPos.locator.slice();
              var jitMasking =
                noJit === true ? false : opts.jitMasking !== false ? opts.jitMasking : test.jit;
              if (
                jitMasking === false ||
              ...
              function staticCanMatchDefinition(source, target) {
                ...
                canMatch =
                  canMatch && source.match.fn === null && target.match.fn !== null
                    ? target.match.fn.test(source.match.def, getMaskSet(), pos, false, opts, false)
                    : false;
                return canMatch;
              }
                  ...
                  if (altIndex === -1 || typeof altIndex === 'string') {
                    ...
                    if (getMaskSet().excludes[pos]) {
                      ...
                      for (var i = 0, el = getMaskSet().excludes[pos].length; i < el; i++) {
                        altIndexArr.splice(
                          altIndexArr.indexOf(getMaskSet().excludes[pos][i].toString()),
                          1
                        );
                      }
        ...
        function revalidateMask(pos, validTest, fromSetValid, validatedPos) {
          function IsEnclosedStatic(pos, valids, selection) {
            ...
            if (
              posMatch !== undefined &&
              ((posMatch.match.fn === null && posMatch.match.optionality !== true) ||
                posMatch.input === opts.radixPoint)
            ) {
              var prevMatch =
                  selection.begin <= pos - 1
                    ? valids[pos - 1] && valids[pos - 1].match.fn === null && valids[pos - 1]
                    : valids[pos - 1],
                nextMatch =
                  selection.end > pos + 1
                    ? valids[pos + 1] && valids[pos + 1].match.fn === null && valids[pos + 1]
        ...
        function seekNext(pos, newBlock) {
          ...
          while (
            ...
            ((newBlock === true &&
              (getTest(position).match.newBlockMarker !== true || !isMask(position))) ||
                ...
                for (var i = 0; i < tests.length; i++) {
                  if (
                    ...
                    (tests[i].match.fn === null ||
                      prevTest === undefined ||
                      tests[i].match.fn.test(prevTest.match.def, getMaskSet(), pos, true, opts) !==
                        false)
                  ) {
                ...
                (that.disabled ||
                  (that.readOnly &&
                    !(
                      ...
                      (opts.tabThrough === false && e.keyCode === Inputmask.keyCode.TAB)
                    )))
              ) {
                e.preventDefault();
              } else {
        ...
        var EventHandlers = {
          keydownEvent: function keydownEvent(e) {
            ...
            if (
              ...
              (e.ctrlKey && k === Inputmask.keyCode.X && !isInputEventSupported('cut'))
            ) {
              e.preventDefault();
              ...
              ((opts.undoOnEscape && k === Inputmask.keyCode.ESCAPE) || (k === 90 && e.ctrlKey)) &&
              e.altKey !== true
            ) {
                  ...
                  if (backPart.length > backBufferPart.length) {
                    ...
                    if (backPart.length < backBufferPart.length) {
                      ...
                      if (
                        ...
                        opts.radixPoint !== '' &&
                        backPart === '' &&
                        frontPart.charAt(selection.begin + offset - 1) === opts.radixPoint
                      ) {
                        selection.begin--;
                  ...
                  switch (opts.positionCaretOnClick) {
                    ...
                    default:
                      ...
                      if (clickPosition < lastPosition) {
                        caret(
                          input,
                          !isMask(clickPosition, true) && !isMask(clickPosition - 1, true)
        ...
        function unmaskedvalue(input) {
          ...
          var unmaskedValue =
            umValue.length === 0 ? '' : (isRTL ? umValue.reverse() : umValue).join('');
        ...
        function caret(input, begin, end, notranslate) {
          ...
          if (begin !== undefined) {
            ...
            if ('selectionStart' in input) {
              ...
              begin =
                0 - range.duplicate().moveStart('character', -input.inputmask._valueGet().length);
          ...
          function isElementTypeSupported(input, opts) {
            function patchValueProperty(npt) {
              ...
              function patchValhook(type) {
                if (
                  $.valHooks &&
                  ($.valHooks[type] === undefined || $.valHooks[type].inputmaskpatch !== true)
                ) {
                  var valhookGet =
          ...
          if (isSupported !== false) {
            ...
            if (
              ...
              var initialValue = $.isFunction(opts.onBeforeMask)
                ? opts.onBeforeMask.call(inputmask, el.inputmask._valueGet(true), opts) ||
                  el.inputmask._valueGet(true)
                : el.inputmask._valueGet(true);
      ...
      function analyseMask(maskString, format, opts) {
        ...
        function setValue(dateObj, value, opts) {
          ...
          if (dateOperation !== undefined)
            dateOperation.call(
              dateObj.date,
              targetProp == 'month' ? parseInt(dateObj[targetProp]) - 1 : dateObj[targetProp]
            );
        }
        if (typeof mask === 'string') {
          ...
          mask &&
          (typeof mask === 'undefined' ? 'undefined' : _typeof(mask)) === 'object' &&
        ...
        numeric: {
          ...
          postValidation: function postValidation(buffer, pos, currentResult, opts) {
            ...
            if (charAtPos !== undefined) {
              if (
                ...
                if (
                  ...
                  caretPos < opts.prefix.length - 1 + (opts.isNegative === false ? 1 : 0)
                ) {
                  prefix[caretPos - (opts.isNegative === false ? 1 : 0)] = '?';
                } else if (
                  opts.suffix.length > 0 &&
                  caretPos >=
                    maskedValue.length - opts.suffix.length - (opts.isNegative === false ? 1 : 0)
                ) {
                  suffix[
                    caretPos -
                      (maskedValue.length -
            ...
            if (processValue !== '') {
              ...
              if (
                (!opts.digitsOptional ||
                  (opts.enforceDigitsOnBlur && currentResult.event === 'blur')) &&
              ...
              validator: function validator(chrs, maskset, pos, strict, opts, isSelection) {
                ...
                if (isValid === true) {
                  if (
                    ...
                    while (
                      processValue.match(Inputmask.escapeRegex(bufferTemplate) + '$') === null
                    ) {
          ...
          onBeforeMask: function onBeforeMask(initialValue, opts) {
            ...
            initialValue =
              integerPart + (decimalPart !== '' ? radixPoint + decimalPart : decimalPart);
            var digits = 0;
            if (radixPoint !== '') {
