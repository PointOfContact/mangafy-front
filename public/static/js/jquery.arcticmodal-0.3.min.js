    ...
    f = {
      getParentEl: function (a) {
        ...
        return b.data('arcticmodal')
          ? b
          : (b = d(a).closest('.arcticmodal-container').data('arcticmodalParentEl'))
          ? b
          : !1;
      },
      ...
      init_el: function (a, b) {
        ...
        if (!c) {
          ...
          b.clone
            ...
            : (a.before('<div id="arcticmodalReserve' + c.modalID + '" style="display: none" />'),
              c.body.html(a));
          f.prepare_body(c, a);
              ...
              error: function () {
                ...
                void 0 == l
                  ? (c.body.html(c.errors.tpl),
                    d('.arcticmodal-error', c.body).html(c.errors.ajax_unsuccessful_load),
