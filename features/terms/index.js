            ...
            <div className={styles.title_section}>
              <div className={styles.title_inner}>
                ...
                <div className={styles.page_description}>
                  Hi There! If you’re reading this, you’re probably like me – spending most of your time
                  writing at your desk, in-front of a computer or a notebook, hoping to one day see your
                  vision turning into a graphic novel (comic or even a manga!).
                </div>
              </div>
            ...
            <div className={styles.info_section}>
              ...
              <div className={styles.info_block}>
                ...
                <div className={styles.info_description}>
                  ...
                  management tools to take your idea from story to a fully digital product, ready to be
                  monetised and published. Come and make the next big IP, our platform is for you.
                  <br></br>
                  <br></br>Our team has vast experience in the online scene, and we are all avid fans of
                  all comic, manga and anime…and our vision is clear – to grant a platform that
