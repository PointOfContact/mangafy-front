  ...
  return (
    <>
              ...
              <div className={styles.main__buttons}>
                ...
                <Link href="">
                  <a className={styles.header__menu}>
                    <PrimaryButton className={styles.joinBtn} text="Start a Project"></PrimaryButton>
                  </a>
                </Link>
              </div>
      ...
      <div className={styles.platformDescr}>
        <div className={'container'}>
          ...
          <div className={styles.platformDescr__subtitle}>
            MangaFY was built to help artists focus all their work in one place: collaborate, manage your manga or comic workflow, chat, set deadlines and tasks, and turn your story into a ready-to-be-published graphic novel.
          </div>
          <div className={styles.platformDescr__wrap}>
            <div className={styles.platformDescr__item}>
              ...
              <div className={styles.platformDescr__itemDescr}>
                Join a vivid community of creators (writers, illustrators, editors, translators, <br /> and inkers)
              </div>
            </div>
      ...
      <div className={styles.titleBlock}>
        <div className={'container'}>
          <div className={styles.titleBlock__title}>The future of graphic novel <br /> self-production.</div>
          <div className={styles.titleBlock__subtitle}>
            We believe that in today's digital age, producing your own comic book or manga should not be
            an obstacle.  As such, we have designed simple tools for aspiring and freelance artists to 
            take their stories forward towards a visualized novel - in easy steps.
          </div>
        </div>
      </div>
      ...
      <div className={styles.privAndSecure}>
        <div className={'container'}>
          <div className={styles.privAndSecure__title}>Privately and securely work on <br /> your graphic novel idea. </div>
          <div className={styles.privAndSecure__wrap}>
            <div className={styles.privAndSecure__item}>
              Our tools allow you to <br /> <span className={styles.privAndSecure__itemBold}>manage your storyboard</span> and page scripts, define your characters. 
            </div>
            <div className={styles.privAndSecure__item}>
              <span className={styles.privAndSecure__itemBold}>Grow with new teammates</span>,<br /> invite team members to your secure workspace and collaborate together by setting tasks and ease of communication. 
            </div>
            <div className={styles.privAndSecure__item}>
              <span className={styles.privAndSecure__itemBold}>Seamlessly send files</span> between the team and exchange ideas until you have a finalized graphic novel at hand. 
            </div>
          </div>
          <div className={styles.privAndSecure__subtitle}>
            Once you are done working on your novel you can <span className={styles.privAndSecure__itemBold}>easily publish</span> it through MangaFY on any of the leading <br /> self-publishing platforms and begin getting followers and monetize your work.
          </div>
      ...
      <div className={styles.titleSlider}>
        <div className={'container'}>
          <div className={styles.titleSlider__title}>Join our<br /> community today</div>
          <div className={styles.titleSlider__subtitle}>
            Do you love graphic novels? Want to constantly stay inspired and be<br />
            surrounded by like-minded creators? Then sign-up today and get rewarded for
            your love <br />
            of comics and manga
          </div>
        </div>
