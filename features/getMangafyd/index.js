        ...
        <div className="section2">
          <div className="container">
            ...
            <div className="subtitle">
              Turning into anime character has never been easier! Here is a short guide to the most
              painless process.
            </div>
            <div className="section2__wrap">
              ...
              <div className="section2__btn-wrap">
                <a href="#" className="section2__btn">
                  Give it a try
                </a>
              </div>
            </div>
        ...
        <div className="section3">
          <div className="container">
            <div className="section3__wrap">
              ...
              <a href="#" className="section3__btn">
                Give it a try
              </a>
            </div>
          </div>
        ...
        <div className="section5">
          <div className="container">
            <div className="section5__wrap">
              ...
              <a href="#" className="section5__btn">
                Give it a try
              </a>
            </div>
          </div>
        ...
        <div className="modal">
          <div className="box-modal" id="exampleModal">
            ...
            <div className="subtitle">
              ...
              debitis at numquam temporibus fuga magni, voluptas assumenda libero, nam est nisi quo
              dolorem aliquid accusamus ipsam nesciunt laboriosam.
            </div>
