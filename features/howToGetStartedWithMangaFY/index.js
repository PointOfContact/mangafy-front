          ...
          <div className={styles.content}>
            ...
            <div>
              ...
              <p>
                ...
                translator - open a project, and start collaborating on taking your manga or comic
                or novel idea from story to a ready to self-publication product.
              </p>
            </div>
            <div>
              ...
              />
              <p>
                C. It will lead you to the start of your profile screen where you feel your name,
                your artist role (are you an illustrator, writer, editor, inker, translator, etc.),
                your email, and desired password. And no, worries you can change it later.
              </p>
              <br />
              <b>
                <Imgix
              ...
              <p>
                D. Once done, you will get the following window - press the "Create Your First
                Story" button:
              </p>
              <br />
              <b>
              ...
              <p>Note:</p>
              <p>
                <strong>Note:</strong> building a detailed user profile is extremely important - it
                is your calling card for people to reflect on your works, story, what collaborations
                you are looking for, and connections with the community. Hence, be as detailed as
                you can be.
              </p>
              <p>
              ...
              <p>
                <strong>Under Services</strong> - what services you offer and what is your
                price-rate, i.e - illustrator - how much do you take for 1 page, color page, etc.
                What type of collaborations you look for, free, paid, etc.
              </p>
              <p>
                Welcome! Now, it's time to train and be creative, go to the MangaFY platform, and
                share with us a panel from your upcoming project/story. Have a friend who also
                dreams of learning cool things? loves comics or manga? or has a story he wants to
                turn into a graphic novel? bring him over to MangaFY :).
              </p>
              <div className={styles.share}>
                <div className={styles.items}>
                  <ShareButtons
...
HowToGetStartedWithMangaFY.propTypes = {
  user: PropTypes.object.isRequired,
};

export default HowToGetStartedWithMangaFY;
